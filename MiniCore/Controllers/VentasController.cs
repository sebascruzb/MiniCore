...
namespace MiniCore.Controllers
{
    public class VentasController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Ventas.Include(v => v.Vendedor);
        ...
        public async Task<IActionResult> Create([Bind("Id,Fecha,Monto,VendedorId")] Venta venta)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Fecha,Monto,VendedorId")] Venta venta)
        {
            if (id != venta.Id)
            {
                return NotFound();
